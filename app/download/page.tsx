...
function MacOSButton() {
	return (
		<a className='flex w-full items-center justify-center gap-2 bg-gradient-to-tl from-orange-500 to-red-600 hover:from-red-600 hover:to-orange-500 hover:shadow-lg text-white font-bold py-4 md:px-16 rounded-lg'>
			<svg
...
function WindowsButton() {
	return (
		<a className='flex gap-2 w-full h-full py-4 md:px-16 items-center justify-center bg-gradient-to-tl from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 hover:shadow-lg text-white font-bold rounded-lg'>
			<svg
				viewBox='0 0 88 88'
...
function AppImageButton() {
	return (
		<a className='w-full flex items-center justify-center gap-2 bg-gradient-to-tl from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 hover:shadow-lg text-white font-bold py-4 md:px-16 rounded-lg'>
			<svg
				xmlns='http://www.w3.org/2000/svg'
...
function DebianButton() {
	return (
		<a className='flex gap-2 items-center justify-center w-full bg-gradient-to-tl from-red-500 to-red-600 hover:from-red-400 hover:to-red-500 hover:shadow-lg text-white font-bold py-4 md:px-16 rounded-lg'>
			<svg
				xmlns='http://www.w3.org/2000/svg'
				viewBox='0 0 448 512'
				className='w-4 h-4 fill-current text-white'
